...
void app_main(void)
{
    ...
    audio_element_handle_t raw_write_el_1, raw_write_el_2;
...
#define PLAY_STATUS ESP_DOWNMIX_OUTPUT_TYPE_ONE_CHANNEL
    ...
    esp_downmix_input_info_t source_info[2] = {0};
    ...
    const char *link_tag3[2] = {"mixer", "i2s"};
    audio_pipeline_link(pipeline_mix, &link_tag3[0], 2);
    ...
    downmix_set_output_type(mixer, PLAY_STATUS);
    ...
    while (1) {
        ...
        if (msg.source_type == AUDIO_ELEMENT_TYPE_ELEMENT
            && (msg.source == (void *)mp3_decoder || msg.source == (void *)mp3_decoder2)
